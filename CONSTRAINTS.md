...
Last movement: 2026-09-11 took the dump population from 2,380 to 529 units
...
The bar is still strict in the direction that matters: 529 of 2,844 units
...
**Open question for the next session (not a bar change).** That 529 is not a
...
|---|---|---|
| `test_recovered_sources_have_no_emit_byte_dumps` | 529 dump units | function recovery |
...
|---|---|---|---|---|---|
| E1 | `_emit` floor | `src/**` | 529 units still to convert; tracked by the ratchet above | 2026-09-11 session | on completion |
