...
class DumpExtentTests(unittest.TestCase):
    ...
    def test_resolved_pattern_matches_the_retail_slice(self):
        ...
        # 529 units as `tools/gen_mnem.py` re-emitted them as mnemonics or
        # transcribed them as data.
        self.assertGreater(checked, 450)
    ...
    def test_function_shaped_units_are_framed_and_end_with_a_return(self):
        ...
        for row in self.rows:
            ...
            seen += 1
        # 512 complete functions are still dump-shaped (was 1,142).
...
class CoverageReportTests(unittest.TestCase):
    ...
    DUMP_PERCENT_CEILING = {"exe-code": 44.75, "ovl-payload": 33.06}
